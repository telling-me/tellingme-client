...
// 세팅
export const SETTING_TERMS_OF_SERVICE_DOCS = [
  `■ 제1장 총칙`,
  `<제1조(목적)>`,
  `이 약관은 TellingUS (이하 “회사”)가 운영하는 tellingme 서비스(이하 “텔링미”)를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.`,
  `<제2조(정의)>`,
  ...
  `① 회사는 본 약관의 내용을 텔링미의 회원가입 페이지 및 설정 페이지를 통해 이용자에게 통지하고, 그 내용에 동의한 이용자가 본 서비스에 가입하여 회원이 되었을 때 본 약관의 효력이 발생합니다.
  ...
  `<제4조(회원가입)>`,
  `① 이용자는 회사에서 제공하는 회원가입 페이지에서 이 약관에 동의한다는 의사표시를 하고 회원정보를 기입함으로써 회원가입을 완료합니다.

  ② 회사는 이용자가 회원가입 페이지의 ‘동의합니다’ 버튼을 클릭한 경우 본 약관에 동의한 것으로 간주합니다.`,
  `<제5조(회원정보의 변경)>`,
  `① 이용자는 설정 페이지 내 ‘내 정보 수정하기’ 탭을 통해 언제든지 본인의 개인정보를 열람 및 수정할 수 있습니다.
  ...
  `<제6조(회원 탈퇴 및 자격 상실 등)>`,
  `① 이용자는 언제든지 서비스 이용을 원하지 않는 경우 설정 페이지 내 ‘회원 탈퇴’ 탭을 통해 이용계약을 해지할 수 있습니다. 
  ...
  `<제7조(회원에 대한 통지)>`,
  `① 회사가 이용자에게 통지를 하는 경우 개별 알림 기능으로 할 수 있습니다.

  ② 회사는 이용자 전체에게 통지를 하는 경우 7일 이상 알림 페이지 또는 팝업화면 등을 제시함으로써 제1항의 통지에 갈음할 수 있습니다.`
]

export const SETTING_TERMS_OF_SERVICE_TEXTP_INFO = [
  {
    _typo: 'b1_b',
    _margin: '0 0 4px 0'
  },
...
export const SETTING_PRIVACY_POLICY_TEXTP_INFO = [
  {
    _typo: 'b2_b',
    _margin: '0 0 12px 0'
  },
...
export const SETTING_PRIVACY_POLICY_DOCS = [
  `< 텔링어스 >는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.`,
  `○ 이 개인정보처리방침은 2023년 1월 1부터 적용됩니다.`,
  `제1조(개인정보의 처리 목적)`,
  `< 텔링어스 >('tellingme.co.kr'이하 'tellingme')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
  ...
  `① < 텔링어스 >은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
  ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
  1.<서비스 제공>
  <서비스 제공>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<1년>까지 위 이용목적을 위하여 보유.이용됩니다.
  보유 목적 : 질의응답, 개인 컨텐츠, 문의하기`,
  `제3조(개인정보 수집)`,
  `① 이용자가 회원가입을 할 경우, 회사는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
  ...
  `① < 텔링어스 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.`,
  `제5조(개인정보처리의 위탁에 관한 사항)`,
  `① 회사는 원칙적으로 이용자 동의 없이 이용자의 개인정보를 외부에 공개하지 않습니다. 단 이용자가 외부 제휴사의 서비스를 이용하기 위하여 개인정보 제공 및 위탁에 직접 동의한 경우는 예외로 합니다. 또한 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우에는 특정 개인을 알아볼 수 없는 통계 자료의 형태로 가공하여 제공할 수 있습니다. ② < 텔링어스 >은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다. ③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.`,
  `제6조(개인정보의 파기절차 및 파기방법)`,
  `① < 텔링어스 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
  ...
  `① 정보주체는 텔링어스에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
  ...
  `< 텔링어스 >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
  ...
  `행태정보의 수집·이용·제공 및 거부등에 관한 사항 <텔링어스>는 온라인 맞춤형 광고 등을 위한 행태정보를 수집·이용·제공하지 않습니다.`,
  `제11조(추가적인 이용·제공 판단기준)`,
  `< 텔링어스 > 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.
  ...
  `① 텔링어스 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
 ...
 경찰청 사이버안전국: 국번 없이 182 (http://cyberbureau.police.go.kr)`,
  `제 13조 개인정보 처리방침의 개정 및 공지`,
  `회사는 법률이나 서비스의 변경사항을 반영하기 위한 목적 등으로 본 개인정보 처리방침을 수정할 수 있습니다. 내용에 대한 추가, 삭제 및 수정이 있을 경우 시행일 최소 7일 전부터 홈페이지 상에 공지합니다.`
]

export const SETTING_WITHDRAWAL_DOCS = `텔링미(telling me)에서는 뉴스레터 발송과 관련하여 ｢개인정보보호법」 제15조 제1항 제1호, 제17조 제1항 제1호, 제23조 제1호, 제24조 제1항 제1호에 따라 아래와 같이 개인정보의 수집 ·이용 및 제3자 제공에 관하여 귀하의 동의를 얻고자 합니다.
■ 수집·이용 목적
◦ 뉴스레터 발송을 위한 최소한의 개인정보를 수집하고 있습니다. 수집된 정보는 ｢텔링미(telling me) 뉴스레터｣ 발송 외 다른 목적으로 사용되지 않습니다. 
■ 수집·이용할 항목
◦ (필수항목) 성명, 연락처(E-Mail)
